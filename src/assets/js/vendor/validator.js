    ...
    FormValidator.prototype = {
        ...
        tests : {
            ...
            hasValue : function( data ){
                const error = data.invaildtext || this.texts.empty;
                return data.value ? true : error   
            },
            ...
            tel: function(field, data) {
                const pattern = this.settings.regex.tel;
            ...
            select : function( field, data ){
                let error = data.invaildtext || this.texts.select;
                return data.value ? true : error;
            },

            checkbox : function( field, data ){
                if( field.checked ) return true;
                let error = data.invaildtext || this.texts.checked;
        ...
        */
        ...
        testByType : function( field, data ){
            ...
            if( !type || type == 'password' || type == 'search' || type == 'file' )
                type = 'text';
